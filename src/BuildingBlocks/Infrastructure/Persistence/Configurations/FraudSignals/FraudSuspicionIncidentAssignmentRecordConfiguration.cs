...
public sealed class FraudSuspicionIncidentAssignmentRecordConfiguration : IEntityTypeConfiguration<FraudSuspicionIncidentAssignmentRecord>
{
    public void Configure(EntityTypeBuilder<FraudSuspicionIncidentAssignmentRecord> builder)
    {
        builder.ToTable("fraud_suspicion_incident_assignments");
